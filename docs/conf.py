...
htmlhelp_basename = 'desdeo-visdoc'
...
latex_documents = [
    (master_doc, 'desdeo-vis.tex', 'desdeo-vis Documentation',
     'Frankie Robertson', 'manual'),
]
...
man_pages = [
    (master_doc, 'desdeo-vis', 'desdeo-vis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'desdeo-vis', 'desdeo-vis Documentation',
     author, 'desdeo-vis', 'One line description of project.',
     'Miscellaneous'),
]
